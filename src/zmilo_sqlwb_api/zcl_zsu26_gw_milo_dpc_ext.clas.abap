...
CLASS ZCL_ZSU26_GW_MILO_DPC_EXT IMPLEMENTATION.
      ...
      WHEN 'GETFIELDS'.
        ...
        TRY.
            ...
            LOOP AT lt_get_field INTO DATA(ls_ddic_field).
              ...
              <ls_field_response>-origintype = ls_ddic_field-origin_type.
              <ls_field_response>-originstructure = ls_ddic_field-origin_structure.
  ...
  METHOD sqlwbcolumnset_get_entityset.
    ...
    LOOP AT lt_column INTO DATA(ls_column).
      ...
      <ls_entity>-origintype = ls_column-origin_type.
  ...
  METHOD sqlwbuserprofile_get_entityset.
    ...
    DATA lv_skip   TYPE i.
    DATA lv_top    TYPE i.
    DATA lt_role   TYPE zcl_milo_service=>tt_role.

    lt_role = zcl_milo_service=>list_user_profiles( ).
    ...
    LOOP AT lt_role INTO DATA(ls_role).
      ...
      <ls_entity>-profileid = ls_role-profile_id.
      <ls_entity>-pfcgrole = ls_role-pfcg_role.
      <ls_entity>-description = ls_role-description.
      <ls_entity>-maxrows = ls_role-max_rows.
    ENDLOOP.
  ENDMETHOD.
ENDCLASS.
