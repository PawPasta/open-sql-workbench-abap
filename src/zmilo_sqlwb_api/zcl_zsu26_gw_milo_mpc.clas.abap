class ZCL_ZSU26_GW_MILO_MPC definition
  public
...
TT_SQLWBCOLUMN type standard table of TS_SQLWBCOLUMN .
  types:
  begin of TS_SQLWBFIELD,
     PROFILEID type C length 30,
     OBJECTNAME type C length 40,
     POSITION type I,
     FIELDNAME type C length 30,
     JSONKEY type C length 40,
     ELEMENT type C length 30,
     ABAPTYPE type C length 4,
     LENGTH type I,
     DECIMALS type I,
     ISKEY type FLAG,
...
TT_SQLWBFIELD type standard table of TS_SQLWBFIELD .
  types:
  begin of TS_SQLWBPAGECHUNK,
     RESULTID type string,
     PAGENO type string,
     CHUNKNO type I,
     PAYLOADPART type string,
     PAYLOADLEN type I,
     ISLASTCHUNK type FLAG,
  end of TS_SQLWBPAGECHUNK .
  types:
TT_SQLWBPAGECHUNK type standard table of TS_SQLWBPAGECHUNK .
  types:
  begin of TS_SQLWBRUNRESULT,
     RESULTID type C length 32,
     ...
     TOTALPAGES type I,
     TRUNCATED type FLAG,
     ERRORCODE type C length 40,
     ERRORTEXT type C length 255,
  end of TS_SQLWBRUNRESULT .
  types:
TT_SQLWBRUNRESULT type standard table of TS_SQLWBRUNRESULT .
  types:
  begin of TS_SQLWBSAVEDQUERY,
     QUERYID type C length 32,
     PROFILEID type C length 30,
     ...
     VISIBILITY type C length 10,
     ISACTIVE type FLAG,
     CREATEDDATE type C length 8,
     CREATEDTIME type C length 6,
     TAGS type C length 120,
     DESCRIPTION type C length 255,
  end of TS_SQLWBSAVEDQUERY .
  types:
TT_SQLWBSAVEDQUERY type standard table of TS_SQLWBSAVEDQUERY .
  types:
  begin of TS_SQLWBSAVEQUERYRESULT,
     QUERYID type C length 32,
     STATUS type C length 20,
     ERRORCODE type C length 40,
     ERRORTEXT type C length 255,
  end of TS_SQLWBSAVEQUERYRESULT .
  types:
TT_SQLWBSAVEQUERYRESULT type standard table of TS_SQLWBSAVEQUERYRESULT .
  types:
  begin of TS_SQLWBTABLE,
     PROFILEID type C length 30,
     OBJECTNAME type C length 40,
     OBJECTTYPE type C length 10,
     DESCRIPTION type C length 255,
...
TT_SQLWBTABLE type standard table of TS_SQLWBTABLE .
  ...
  constants GC_SQLWBPAGECHUNK type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SqlwbPageChunk' ##NO_TEXT.
  constants GC_SQLWBRUNRESULT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SqlwbRunResult' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_SQLWBCOLUMN
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SQLWBFIELD
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SQLWBPAGECHUNK
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SQLWBRUNRESULT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SQLWBSAVEDQUERY
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SQLWBSAVEQUERYRESULT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZSU26_GW_MILO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSU26_GW_MILO_SRV' ).

define_sqlwbcolumn( ).
define_sqlwbfield( ).
define_sqlwbpagechunk( ).
define_sqlwbrunresult( ).
...
lo_action = model->create_action( 'GetFields' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'SqlwbField' ). "#EC NOTEXT
...
lo_action = model->create_action( 'RunSavedQuery' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'SqlwbRunResult' ). "#EC NOTEXT
*Set HTTP method GET or POST
lo_action->set_http_method( 'POST' ). "#EC NOTEXT
...
lo_action = model->create_action( 'SaveQuery' ).  "#EC NOTEXT
*Set return entity type
...
lo_action = model->create_action( 'SearchTables' ).  "#EC NOTEXT
*Set return entity type
lo_action->set_return_entity_type( 'SqlwbTable' ). "#EC NOTEXT
*Set HTTP method GET or POST
lo_action->set_http_method( 'GET' ). "#EC NOTEXT
* Set return type multiplicity
lo_action->set_return_multiplicity( 'M' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SqlwbColumn' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'ResultId' iv_abap_fieldname = 'RESULTID' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'JsonKey' iv_abap_fieldname = 'JSONKEY' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'AbapType' iv_abap_fieldname = 'ABAPTYPE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'IsKey' iv_abap_fieldname = 'ISKEY' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSU26_GW_MILO_MPC=>TS_SQLWBCOLUMN' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SqlwbColumnSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SqlwbField' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSU26_GW_MILO_MPC=>TS_SQLWBFIELD' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SqlwbFieldSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - SqlwbPageChunk
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SqlwbPageChunk' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PageNo' iv_abap_fieldname = 'PAGENO' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ChunkNo' iv_abap_fieldname = 'CHUNKNO' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_int32( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PayloadPart' iv_abap_fieldname = 'PAYLOADPART' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PayloadLen' iv_abap_fieldname = 'PAYLOADLEN' ). "#EC NOTEXT
lo_property->set_type_edm_int32( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'IsLastChunk' iv_abap_fieldname = 'ISLASTCHUNK' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSU26_GW_MILO_MPC=>TS_SQLWBPAGECHUNK' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SqlwbPageChunkSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - SqlwbRunResult
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SqlwbRunResult' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ReturnedRows' iv_abap_fieldname = 'RETURNEDROWS' ). "#EC NOTEXT
lo_property->set_type_edm_int32( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TotalRows' iv_abap_fieldname = 'TOTALROWS' ). "#EC NOTEXT
lo_property->set_type_edm_int32( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Page' iv_abap_fieldname = 'PAGE' ). "#EC NOTEXT
lo_property->set_type_edm_int32( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PageSize' iv_abap_fieldname = 'PAGESIZE' ). "#EC NOTEXT
lo_property->set_type_edm_int32( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TotalPages' iv_abap_fieldname = 'TOTALPAGES' ). "#EC NOTEXT
lo_property->set_type_edm_int32( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Truncated' iv_abap_fieldname = 'TRUNCATED' ). "#EC NOTEXT
lo_property->set_type_edm_boolean( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ErrorCode' iv_abap_fieldname = 'ERRORCODE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 40 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSU26_GW_MILO_MPC=>TS_SQLWBRUNRESULT' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SqlwbRunResultSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - SqlwbSavedQuery
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SqlwbSavedQuery' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'QueryId' iv_abap_fieldname = 'QUERYID' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 32 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'QueryName' iv_abap_fieldname = 'QUERYNAME' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'QueryText' iv_abap_fieldname = 'QUERYTEXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Visibility' iv_abap_fieldname = 'VISIBILITY' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSU26_GW_MILO_MPC=>TS_SQLWBSAVEDQUERY' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SqlwbSavedQuerySet' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_SQLWBSAVEQUERYRESULT.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - SqlwbSaveQueryResult
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SqlwbSaveQueryResult' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSU26_GW_MILO_MPC=>TS_SQLWBSAVEQUERYRESULT' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SqlwbSaveQueryResultSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'SqlwbTable' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSU26_GW_MILO_MPC=>TS_SQLWBTABLE' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SqlwbTableSet' ). "#EC NOTEXT
